...
// ===============  GET: announcement report data ==============
export const getVATBillsReportData = () => {}
// ===============  GET: announcement report data ==============
export const getUnitsWillVacatedReportData = () => {}
// ===============  GET: announcement report data ==============
export const getUnitConditionConstructionReportData = () => {}
// ===============  GET: announcement report data ==============
export const getTrialBalanceReportData = () => {}
// ===============  GET: announcement report data ==============
export const getSoldVillasReportData = () => {}
// ===============  GET: announcement report data ==============
export const getSoldUnitsReportData = () => {}
// ===============  GET: announcement report data ==============
export const getSoldLandsReportData = () => {}
// ===============  GET: announcement report data ==============
export const getSheetReportData = () => {}
// ===============  GET: announcement report data ==============
export const getServicesContractsReportData = () => {}
// ===============  GET: announcement report data ==============
