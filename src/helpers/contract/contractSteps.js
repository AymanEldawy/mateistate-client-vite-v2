...
const GLOBAL_CONTRACT_STEPS = {
  ...
  contract_other_fees_step: "other_fees",
  contract_fixed_assets_step: "fixed_assets",
  contract_linked_parking_step: "linked_parking",
  contract_contract_cycle_step: "contract_cycle",
