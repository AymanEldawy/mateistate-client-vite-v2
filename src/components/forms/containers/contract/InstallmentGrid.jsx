    ...
    <>
      {watch("installmentGrid")?.length ? (
        ...
        >
          ...
          {errors?.installmentGrid_amount ? (
            <ErrorText>
              {errors?.installmentGrid_amount?.message}{" "}
              {watch("installment.restAmount")}
            </ErrorText>
          ) : null}
          <TableForm
            gridName="installmentGrid"
            headers={[
              "internalNumber",
              "amount",
              "dueDate",
            ...
            renderFields={(item, index) => (
              <>
                ...
                <td className="border text-center">
                  <RHFDatePicker name={`installmentGrid.${index}.dueDate`} />
                </td>
                <td className="border text-center">
                  <RHFTableAsyncSelect
                ...
                <td className="border text-center w-[180px]">
                  <RHFTableInput name={`installmentGrid.${index}.note1`} />
                </td>
                <td className="border text-center w-[180px]">
                  <RHFTableInput name={`installmentGrid.${index}.note2`} />
                </td>
                <td className="border text-center">
                  <RHFDatePicker name={`installmentGrid.${index}.endDueDate`} />
                </td>
              </>
            )}
            // errors={errors}
            ...
            // rowsCount={watch("installmentGrid")?.length}
