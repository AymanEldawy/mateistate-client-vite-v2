...
const ShopForm = ({ tab }) => {
  ...
  const ShopGeneralFields = (
    <div className="grid grid-cols-2 gap-2">
      <BuildingField name="shop.buildingId" label="building" required />
      ...
      <UserField name="shop.customerId" label="customer" />
      <RHFAsyncSelectField
        table="owner"
        name="shop.customerOwnerId"
        label="customer_owner"
      />
      <AccountLeaveField name="shop.flatOwnerId" label="flat_owner" />
      ...
      <CostCenterField
        ...
        allowAdd
      />
      <CostCenterField name="shop.costCenterId" label="cost_center" allowAdd />
      ...
      <TableForm
        renderFields={(item, index) => (
          <>
            <td>
              <RHFTableAsyncSelect
                name={`shopFixedAssets.${index}.shopId`}
                label="shop_id"
              />
            </td>
            <td>
              <RHFTableAsyncSelect
                name={`shopFixedAssets.${index}.assetId`}
                label="asset_id"
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopFixedAssets.${index}.value`}
                label="value"
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopFixedAssets.${index}.note`}
                label="note"
              />
            </td>
          </>
        ...
        headers={["shop_id", "asset_id", "value", "note"]}
      />
    </div>
  );
      ...
      <TableForm
        renderFields={(item, index) => (
          <>
            <td>
              <RHFDatePicker
                name={`shopRentalPrices.${index}.date`}
                type="date"
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopRentalPrices.${index}.price`}
                label="price"
                type="number"
              />
            </td>
            <td>
              <RHFAsyncSelectField
                name={`shopRentalPrices.${index}.currencyId`}
                table="currency"
                allowAdd
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopRentalPrices.${index}.note`}
                label="note"
              />
            </td>
          </>
      ...
      <TableForm
        renderFields={(item, index) => (
          <>
            <td>
              <RHFDatePicker
                name={`shopSellingPrices.${index}.date`}
                type="date"
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopSellingPrices.${index}.price`}
                label="price"
                type="number"
              />
            </td>
            <td>
              <RHFAsyncSelectField
                name={`shopSellingPrices.${index}.currencyId`}
                table="currency"
                allowAdd
              />
            </td>
            <td>
              <RHFTableInput
                name={`shopSellingPrices.${index}.note`}
                label="note"
              />
            </td>
          </>
